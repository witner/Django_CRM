# Generated by Django 2.2.5 on 2019-09-16 17:17
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_teacher', models.ForeignKey(limit_choices_to={'depart__title': '教质部'}, on_delete=django.db.models.deletion.CASCADE, related_name='classes', to='app_crm.UserInfo', verbose_name='班主任')),
            ],
        ),
        migrations.CreateModel(
            name='Course',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_object', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_crm.ClassList', verbose_name='班级')),
                ('teacher', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_crm.UserInfo', verbose_name='讲师')),
            ],
        ),
        migrations.CreateModel(
            name='Customer',
            fields=[
                ...
                ('consultant', models.ForeignKey(blank=True, limit_choices_to={'depart__title': '销售部'}, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='consultant', to='app_crm.UserInfo', verbose_name='课程顾问')),
                ('course', models.ManyToManyField(to='app_crm.Course', verbose_name='咨询课程')),
                ('referral_from', models.ForeignKey(blank=True, help_text='若此客户是转介绍自内部学员,请在此处选择内部学员姓名', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='internal_referral', to='app_crm.Customer', verbose_name='转介绍自学员')),
            ],
        ),
        migrations.CreateModel(
            name='Student',
            fields=[
                ...
                ('class_list', models.ManyToManyField(blank=True, to='app_crm.ClassList', verbose_name='已报班级')),
                ('customer', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='app_crm.Customer', verbose_name='客户信息')),
            ],
        ),
        migrations.CreateModel(
            name='StudyRecord',
            fields=[
                ...
                ('course_record', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_crm.CourseRecord', verbose_name='第几天课程')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_crm.Student', verbose_name='学员')),
            ],
        ),
        migrations.CreateModel(
            name='ScoreRecord',
            fields=[
                ...
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_crm.Student', verbose_name='学生')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_crm.UserInfo', verbose_name='执行人')),
            ],
        ),
        migrations.CreateModel(
            name='PaymentRecord',
            fields=[
                ...
                ('class_list', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_crm.ClassList', verbose_name='申请班级')),
                ('confirm_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='confirms', to='app_crm.UserInfo', verbose_name='审批人')),
                ('consultant', models.ForeignKey(help_text='谁签的单就选谁', on_delete=django.db.models.deletion.CASCADE, to='app_crm.UserInfo', verbose_name='课程顾问')),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_crm.Customer', verbose_name='客户')),
            ],
        ),
        migrations.CreateModel(
            name='ConsultRecord',
            fields=[
                ...
                ('consultant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_crm.UserInfo', verbose_name='跟踪人')),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_crm.Customer', verbose_name='所咨询客户')),
            ],
        ),
        migrations.AddField(
            model_name='classlist',
            name='course',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_crm.Course', verbose_name='课程名称'),
        ),
        migrations.AddField(
            model_name='classlist',
            name='school',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_crm.School', verbose_name='校区'),
        ),
        migrations.AddField(
            model_name='classlist',
            name='tech_teachers',
            field=models.ManyToManyField(blank=True, limit_choices_to={'depart__title__in': ['Linux教学部', 'Python教学部']}, related_name='teach_classes', to='app_crm.UserInfo', verbose_name='任课老师'),
        ),
    ]
